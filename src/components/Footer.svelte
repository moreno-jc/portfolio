...
>
  ...
  >
    <span class="text-sm sm:text-center text-zinc-800/90 dark:text-zinc-200/90"
      >© {currentYear}
      <a href="https://midu.dev/" class="hover:underline">{data.name}</a>
    ...
    >
      <li>
        <a href="/#sobre-mi" class="hover:underline me-4 md:me-6">{data.navItems[2].title}</a>
      </li>
      <li>
        <a id="contacto" href="mailto:miduga@gmail.com" class="hover:underline"
          >{data.navItems[3].title}</a
        >
      </li>
    </ul>
  </div>
